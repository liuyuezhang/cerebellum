...
python -m main --granule rc       --k 4  --n-hidden 200000 --lr 2.5e-6    --ltd none --seed $SEED --wandb --save &
python -m main --granule fc              --n-hidden 5970   --lr 8.375e-5  --ltd ma   --seed $SEED --wandb --save &
python -m main --granule fc              --n-hidden 5970   --lr 8.375e-5  --ltd none --seed $SEED --wandb --save &